CREATE TABLE IF NOT EXISTS `scalar_db_books` (
  ...
  `custom_js` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `scalar_db_user_books` (
  ...
  `book_id` int(10) unsigned NOT NULL DEFAULT '0',
  `relationship` enum('author','editor','commentator','reviewer','reader') COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `scalar_db_versions` (
  ...
  `alt_text` text COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `editorial_state` enum('draft','edit','editreview','clean','ready','published') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'draft',

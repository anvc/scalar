	...
	<script>
		...
		function deleteFiles() {
			...
			$.post('api/delete_content', data, function(data) {
			  ...
			  var str = '';
			  if (data.content.length > 0) str += ucwords(toWords(data.content.length))+'pages';
		...
		<select name="relType" style="min-width:200px;float:left;margin-right:3px;font-size:12px;" class="generic_text_input" >

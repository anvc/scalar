...
$config['views'] = array(
	...
	'image_header' => array('name'=>'Image Header','description'=>'<b>Adds a large image at the top.</b> In the Image Header view, the page\'s banner image is shown as a header, with the title and description of the page overlaid. The rest of the page follows the Basic layout, with text and media interspersed.','image'=>'views/melons/cantaloupe/images/view_image_header.gif'),
	'splash' => array('name'=>'Splash','description'=>'<b>Shows a full screen cover for a section.</b> In the Splash view, the page\'s banner image is shown full screen, with the page\'s title at the bottom. If the page is part of a path or is itself a path, a navigation button is shown as well.','image'=>'views/melons/cantaloupe/images/view_splash.gif'),
	'book_splash' => array('name'=>'Book Splash','description'=>'<b>Shows a full screen cover for your book.</b> In the Book Splash layout, the page\'s banner image (either its own, or one inherited from its parent) is shown full screen, with the book\'s title and author(s) at the bottom. If the page is part of a path or is itself a path, a navigation button is shown as well.','image'=>'views/melons/cantaloupe/images/view_book_splash.gif'),
	'gallery' => array('name'=>'Media Gallery','description'=>'<b>Embeds all the related media.</b> In the Media Gallery view, media referenced, contained, or tagged by the page are compiled into a full width gallery just below the page\'s title.','image'=>'views/melons/cantaloupe/images/view_gallery.gif'),

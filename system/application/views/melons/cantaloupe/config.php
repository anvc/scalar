...
$config['views'] = array(
	...
	'image_header' => array('name'=>'Image Header','description'=>'<b>Adds a large image at the top.</b> In the Image Header view, the page\'s key image is shown as a header, with the title and description of the page overlaid. The rest of the page follows the Basic layout, with text and media interspersed.','image'=>'views/melons/cantaloupe/images/view_image_header.gif'),
	'splash' => array('name'=>'Splash','description'=>'<b>Shows a full screen cover for a section.</b> In the Splash view, the page\'s key image is shown full screen, with the page\'s title at the bottom. If the page is part of a path or is itself a path, a navigation button is shown as well.','image'=>'views/melons/cantaloupe/images/view_splash.gif'),

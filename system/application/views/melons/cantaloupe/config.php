...
$config['views'] = array(
			...
			'image_header' => array('name'=>'Image Header','description'=>'In the <b>Image Header</b> layout, the page\'s background image is shown as a header, with the title and description of the page overlaid. The rest of the page follows the Basic layout, with text and media interspersed.','image'=>'view_image_header.gif'),
			'splash' => array('name'=>'Splash','description'=>'In the <b>Splash</b> layout, the page\'s background image is shown full screen, with the page\'s title at the bottom. If the page is part of a path or is itself a path, a navigation button is shown as well.','image'=>'view_splash.gif'),
			...
			'structured_gallery' => array('name'=>'Structured Media Gallery','description'=>'In the <b>Structured Media Gallery</b> layout, media contained, tagged, or linked up to two levels deep are grouped into titled galleries of thumbnails which reveal the media in a larger view when clicked.','image'=>'view_structured_gallery.gif'),

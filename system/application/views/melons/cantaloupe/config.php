...
$config['views'] = array(
			...
			'vispath' => array('name'=>'Path','description'=>'The <b>Path</b> view embeds a visualization at the top of the page that shows the path contents of the current page in a tree diagram. The reader can expand sub-paths of the tree to explore its contents. The rest of the page follows the Basic layout, with text and media interspersed.','image'=>'view_path.gif'),
			'vismedia' => array('name'=>'Media','description'=>'The <b>Media</b> view embeds a force-directed visualization at the top of the page that shows the media it references or annotates. The rest of the page follows the Basic layout, with text and media interspersed.','image'=>'view_tag.gif'),

...
$config['views'] = array(
	'plain' => array('name'=>'Basic','description'=>'<b>Freely mixes text and media.</b> In the Basic view, the page\'s text and media are interspersed. You can set the size and placement of linked media as they are added to the page.','image'=>'views/melons/honeydew/images/view_basic.gif'),
	...
	'gallery' => array('name'=>'Media Gallery','description'=>'<b>Embeds all the related media.</b> In the Media Gallery view, media contained or tagged by the page are embedded at full width into a vertically scrolling gallery.','image'=>'views/melons/honeydew/images/view_gallery.gif'),
	...
	'annotation_editor' => '',
	'versions' => '',
	'meta' => array('name'=>'Metadata','description'=>'<b>Displays all metadata for the page.</b> The Metadata view displays a table containing all of the metadata for the page, including all of its prior versions.','image'=>'views/melons/honeydew/images/view_metadata.gif'),
	'history' => ''
);

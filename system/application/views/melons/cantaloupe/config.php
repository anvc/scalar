...
$config['views'] = array(
	...
	'path_splash' => array('name'=>'Path Splash','group'=>'General','description'=>'<b>Shows an image-based menu of path contents.</b> In the Path Splash layout, the key images from each item in the path are used to build a visual index of the path\'s contents. <a href="http://scalar.usc.edu/works/guide2/path-splash-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_path_splash.gif'),

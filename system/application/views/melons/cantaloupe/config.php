...
$config['views'] = array(
	...
	'gallery' => array('name'=>'Media Gallery','description'=>'<b>Embeds all the related media.</b> In the Media Gallery view, media contained or tagged by the page are compiled into a full width gallery just below the page\'s title.','image'=>'views/melons/cantaloupe/images/view_gallery.gif'),

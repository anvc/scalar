...
$config['views'] = array(
	'plain' => array('name'=>'Basic','group'=>'General','description'=>'<b>Freely mixes text and media.</b> In the Basic layout, the page\'s text and media are interspersed. You can set the size and placement of linked media as they are added to the page.','image'=>'views/melons/cantaloupe/images/view_basic.gif'),
	'image_header' => array('name'=>'Image Header','group'=>'General','description'=>'<b>Adds a large image at the top.</b> In the Image Header layout, the page\'s key image is shown as a header, with the title and description of the page overlaid. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/image-header-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_image_header.gif'),
	'splash' => array('name'=>'Splash','group'=>'General','description'=>'<b>Shows a full screen cover for a section.</b> In the Splash layout, the page\'s key image is shown full screen, with the page\'s title at the bottom. If the page is part of a path or is itself a path, a navigation button is shown as well. <a href="http://scalar.usc.edu/works/guide2/splash-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_splash.gif'),
	'book_splash' => array('name'=>'Book Splash','group'=>'General','description'=>'<b>Shows a full screen cover for your book.</b> In the Book Splash layout, the page\'s key image (either its own, or one inherited from its parent) is shown full screen, with the book\'s title and author(s) at the bottom. If the page is part of a path or is itself a path, a navigation button is shown as well. <a href="http://scalar.usc.edu/works/guide2/book-splash-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_book_splash.gif'),
	'visual_path' => array('name'=>'Visual Path','group'=>'General','description'=>'<b>Shows an image-based menu of path contents.</b> In the Visual Path layout, the key images from each item in the path are used to build a visual index of the path\'s contents. <a href="http://scalar.usc.edu/works/guide2/visual-path-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_path_splash.gif'),
	'gallery' => array('name'=>'Media Gallery','group'=>'Interactive','description'=>'<b>Embeds all the related media.</b> In the Media Gallery layout, media referenced, contained, or tagged by the page are compiled into a full width gallery just below the page\'s title. <a href="http://scalar.usc.edu/works/guide2/media-gallery-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_gallery.gif'),
	'structured_gallery' => array('name'=>'Structured Media Gallery','group'=>'Interactive','description'=>'<b>Shows thumbnail galleries for all the media related to this page and its children.</b> In the Structured Media Gallery layout, media contained, tagged, or linked up to two levels deep are grouped into titled galleries of thumbnails which reveal the media in a larger view when clicked. The description for each path and tag is included just above its gallery. <a href="http://scalar.usc.edu/works/guide2/structured-media-gallery-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_structured_gallery.gif'),
	'google_maps' => array('name'=>'Google Map','group'=>'Interactive','description'=>'<b>Adds a map at the top.</b> The Google Map layout plots the current page plus any content it contains or tags on a Google Map embedded at the top of the page. Every piece of content to be plotted must include <i>dcterms:coverage</i> or <i>dcterms:spatial</i> (either will work) metadata in the format <i>decimal latitude,decimal longitude</i> (which can be added using the \'Metadata\' tab above). Each pin shown on the map will reveal the title, description, and link for its content when clicked. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/google-map-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_google_map.gif'),
	'timeline' => array('name'=>'Timeline','group'=>'Interactive','description'=>'<b>Displays chronological pages and media</b> The Timeline layout uses Timeline.js to display any content contained or tagged by the current page in chronological order at its top. Content must include <i>dcterms:temporal</i> or <i>dcterms:date</i> in the format <i>month, day, year, hour, minute, second.</i> Each item on the timeline displays its thumbnail, title, description, and link for its content when clicked. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/timeline-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_timeline.gif'),
	'vistoc' => array('name'=>'Contents','group'=>'Visualizations','description'=>'<b>Visualizes the Table of Contents.</b> The Contents layout embeds a visualization at the top of the page that shows the Table of Contents as a tree diagram. The reader can expand sub-paths of the tree to explore its contents. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/contents-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_path.gif'),
	'visconnections' => array('name'=>'Connections','group'=>'Visualizations','description'=>'<b>Visualizes connections between all content.</b> The Connections layout embeds a force-directed visualization at the top of the page that shows connections between all of the content in the work. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/connections-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_tag.gif'),
	'visindex' => array('name'=>'Grid','group'=>'Visualizations','description'=>'<b>Visualizes all content by type.</b> The Grid layout embeds a visualization at the top of the page that shows content as boxes in a grid. Colored lines are drawn representing connections between the current page and its related content. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/grid-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_grid.gif'),
	'visradial' => array('name'=>'Radial','group'=>'Visualizations','description'=>'<b>Visualizes all related content.</b> The Radial layout embeds a circular visualization at the top of the page that shows connections between content. Colored arcs are drawn representing connections between the current page and its related content, set against the backdrop of all of the other connections in the work. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/radial-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_radial.gif'),
	'vispath' => array('name'=>'Path','group'=>'Visualizations','description'=>'<b>Visualizes the current path.</b> The Path layout embeds a visualization at the top of the page that shows the path contents of the current page in a tree diagram. The reader can expand sub-paths of the tree to explore its contents. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/path-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_path.gif'),
	'vismedia' => array('name'=>'Media','group'=>'Visualizations','description'=>'<b>Visualizes this page\'s media.</b> The Media layout embeds a force-directed visualization at the top of the page that shows the media it references or annotates. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/media-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_tag.gif'),
	'vistag' => array('name'=>'Tag','group'=>'Visualizations','description'=>'<b>Visualizes content tagged by this page.</b> The Tag layout embeds a force-directed visualization at the top of the page that shows the content it tags. The rest of the page follows the Basic layout, with text and media interspersed. <a href="http://scalar.usc.edu/works/guide2/tag-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_tag.gif'),
	'tags' => array('name'=>'Tag Cloud','group'=>'Visualizations','description'=>'<b>Visualizes the prevalence of tags.</b> This layout embeds a tag cloud at the top of the page. If this page is a tag, it will display all items that it tags weighted by the number of pages that the sub-pages tag. If this page is not a tag, it will show all tags in the book weighted by the number of pages they tag.','image'=>'views/melons/cantaloupe/images/view_tags.gif'),
	'blank' => array('name'=>'Blank slate','group'=>'Utility','description'=>'<b>Provides a blank canvas for experimental uses.</b> This layout removes the page\'s title, footer, margins, linked media, and navigation to make room for your content. Ideal for full screen embedded media or alternative interfaces. <a href="http://scalar.usc.edu/works/guide2/blank-slate-layout" target="_blank">Learn more &raquo;</a>','image'=>'views/melons/cantaloupe/images/view_blank.gif'),
	'toc' => array('name'=>'Table of Contents','group'=>'Utility','description'=>'<b>Displays the Table of Contents.</b> This layout includes the work’s Table of Contents, as defined in the Dashboard, below the page content.','image'=>'views/melons/cantaloupe/images/view_toc.gif'),
	'resources' => array('name'=>'Resources','group'=>'Utility','description'=>'<b>Lists all pages and media.</b> The Resources layout lists all pages, followed by all media, in alphabetized lists below the page content.','image'=>'views/melons/cantaloupe/images/view_resources.gif'),
	'meta' => array('name'=>'Metadata','group'=>'Utility','description'=>'<b>Displays all metadata for the page.</b> The Metadata layout displays a table containing all of the metadata for the current version of the page.','image'=>'views/melons/cantaloupe/images/view_media_metadata.gif'),
	'edit' => '',
	'annotation_editor' => '',
	'versions' => '',
	'history' => ''

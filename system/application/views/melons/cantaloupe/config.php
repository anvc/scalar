...
$config['views'] = array(
	...
	'blank' => array('name'=>'Blank slate','description'=>'<b>Provides a blank canvas for experimental uses.</b> This view removes the page\'s title, footer, margins, and navigation so that its area is fully available for your use.','image'=>'views/melons/cantaloupe/images/view_blank.gif'),

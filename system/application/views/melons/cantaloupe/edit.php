...
<tr id="edit_content" class="p type_composite">
	<td colspan="2">
		<div id="wysiwygNewFeatures" class="alert alert-warning alert-dismissible caption_font" role="alert" style="">
		  ...
		  <strong>Looking to add an annotation?</strong> We recently incorporated annotations into our media formatting options. <hr /> Now, to add an annotation to a page, first add a piece of media–using one of the media buttons below—then select to display one or more annotations associated with that piece of media in the formatting options. For step-by-step instructions, see our <a href="http://scalar.usc.edu/works/guide2/" class="alert-link">User’s Guide</a>. Feel free to <a href="http://scalar.usc.edu/contact/" class="alert-link">contact</a> us</a> or post to our <a href="http://scalar.usc.edu/scalar/forums/" class="alert-link">forum</a> if you have any questions.
		</div>

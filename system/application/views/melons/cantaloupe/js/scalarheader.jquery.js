                                    ...
                                    '<div class="collapse navbar-collapse" id="ScalarHeaderMenu">'+
                                        '<ul class="nav navbar-nav navbar-right" id="ScalarHeaderMenuRight">'+
                                            ...
                                            ((base.is_author||base.is_commentator||base.is_reviewer)?
                                                ...
                                                '<li id="ScalarHeaderEdit" class="hidden-xs"><a class="headerIcon" href="' + scalarapi.model.urlPrefix + base.current_slug + '.edit'+ ((scalarapi.getQuerySegment(window.location.href).length)?'?'+scalarapi.getQuerySegment(window.location.href):'') +'"><img src="' + base.options.root_url + '/images/edit_icon.png" alt="Edit button. Click to edit the current page or media." width="30" height="30" /><span class="hidden-sm hidden-md hidden-lg">Edit page</span></a></li>'+

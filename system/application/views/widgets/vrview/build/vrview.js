/*
 * Craig added a few lines related to CURRENT_SCRIPT_SRC on 14 September 2019
 */
...
function Player(selector, contentInfo) {
  // Added by Craig to be able to send the script path through the options object
  if ('undefined' != contentInfo.script_path) {
	  CURRENT_SCRIPT_SRC = contentInfo.script_path
  }

    	...
    	$.getJSON(opts.ontologies_url, function( data ) {  // Propagate with ontologies from the RDF config
        	...
        	if (opts.tklabels && 'undefined' != typeof(opts.tklabels.labels)) {
        		...
        		for (var j = 0; j < opts.tklabels.labels.length; j+=3) {
        			var $row = $('<div class="row"></div>').appendTo($content);
        			if ('undefined'!=typeof(opts.tklabels.labels[j])) $('<div class="cell col-xs-12 col-sm-4" style="padding-bottom:12px;"><label><input type="checkbox" name="'+prefix+':hasLabel" value="'+prefix+':'+opts.tklabels.labels[j].code+'" /><img src="'+opts.tklabels.labels[j].image+'" style="height:40px;vertical-align:middle;margin-left:12px;margin-bottom:6px;" /><br /><span style="padding-left:24px;">'+(('undefined'!=typeof(opts.tklabels.labels[j].text.property1))?opts.tklabels.labels[j].text.property1.description:'')+'</span><br /><small style="display:inline-block;margin-left:24px;line-height:1.35;">'+(('undefined'!=typeof(opts.tklabels.labels[j].text.property2))?opts.tklabels.labels[j].text.property2.description:'')+'</small></label></div>').appendTo($row);
        			if ('undefined'!=typeof(opts.tklabels.labels[j+1])) $('<div class="cell col-xs-12 col-sm-4" style="padding-bottom:12px;"><label><input type="checkbox" name="'+prefix+':hasLabel" value="'+prefix+':'+opts.tklabels.labels[j+1].code+'" /><img src="'+opts.tklabels.labels[j+1].image+'" style="height:40px;vertical-align:middle;margin-left:12px;margin-bottom:6px;" /><br /><span style="padding-left:24px;">'+(('undefined'!=typeof(opts.tklabels.labels[j+1].text.property1))?opts.tklabels.labels[j+1].text.property1.description:'')+'</span><br /><small style="display:inline-block;margin-left:24px;line-height:1.35;">'+(('undefined'!=typeof(opts.tklabels.labels[j+1].text.property2))?opts.tklabels.labels[j+1].text.property2.description:'')+'</small></label></div>').appendTo($row);
        			if ('undefined'!=typeof(opts.tklabels.labels[j+2])) $('<div class="cell col-xs-12 col-sm-4" style="padding-bottom:12px;"><label><input type="checkbox" name="'+prefix+':hasLabel" value="'+prefix+':'+opts.tklabels.labels[j+2].code+'" /><img src="'+opts.tklabels.labels[j+2].image+'" style="height:40px;vertical-align:middle;margin-left:12px;margin-bottom:6px;" /><br /><span style="padding-left:24px;">'+(('undefined'!=typeof(opts.tklabels.labels[j+2].text.property1))?opts.tklabels.labels[j+2].text.property1.description:'')+'</span><br /><small style="display:inline-block;margin-left:24px;line-height:1.35;">'+(('undefined'!=typeof(opts.tklabels.labels[j+2].text.property2))?opts.tklabels.labels[j+2].text.property2.description:'')+'</small></label></div>').appendTo($row);
        		}
            	if (!bootstrap_enabled) {
            		$content.css('display','table').css('width','100%');
            		$content.children('.row').css('display','table-row');

...
// Updated by Craig 22 Aug 2016: changed to REDIRECT_URL
define("PROXY_PREFIX", "http" . (isset($_SERVER["HTTPS"]) ? "s" : "") . "://" . $prefixHost . $prefixPort . $_SERVER["REDIRECT_URL"] . "?");
...
if (isset($_POST["miniProxyFormAction"])) {
  ...
  if (isset($queryParams["miniProxyFormAction"])) {
    ...
    // Updated by Craig 22 Aug 2016: changed to QUERY_STRING
...
// Updated by Craig 22 Aug 2016: trimmed trailing /'s
$responseURL = $responseInfo["url"];
if (trim($responseURL,'/') !== trim($url,'/')) {

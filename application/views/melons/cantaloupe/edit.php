...
<?$this->template->add_css('application/views/widgets/edit/jquery-ui-custom/jquery-ui.min.css')?>
...
$(document).ready(function() {
	...
	*/
	...
	$('.add_additional_metadata:first').on('click', function() {
		var ontologies_url = $('link#approot').attr('href').replace('/application/','')+'/main/ontologies';
	...
	$('.populate_exif_fields:first').on('click', function() {
		...
		var image_metadata_url = $('link#approot').attr('href').replace('/application/','')+'/main/image_metadata';

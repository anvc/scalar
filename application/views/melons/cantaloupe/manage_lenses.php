...
<?php
	...
	$this->template->add_css('application/views/melons/cantaloupe/css/lenses.css');
	$this->template->add_js('application/views/melons/cantaloupe/js/scalarlensmanager.jquery.js');
	$this->template->add_js('application/views/melons/cantaloupe/js/scalarvisualizations.jquery.js');
	$this->template->add_css('application/views/melons/cantaloupe/css/scalarvis.css');
		...
		<div class="col-sm-8 heading_font">
			<div class="lens-edit-container">
				<div class="non-ideal-state-message caption_font">
					<img src="../application/views/melons/cantaloupe/images/icon_lens_lrg.png" alt="Lens icon"/>

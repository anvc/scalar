...
<meta property="og:image" content="<?=confirm_slash($app_root) . 'views/arbors/html5_RDFa/scalar_logo_300x300.png'?>" />
...
<link id="logged_in" href="<?=base_url('main/users/') . $login->user_id?>" />
<? endif ?>

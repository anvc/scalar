...
<?$this->template->add_css('application/views/modules/dashboot/css/bootstrap.min.css')?>
<?$this->template->add_css('application/views/modules/dashboot/css/tabs.css')?>
<?$this->template->add_js('application/views/modules/dashboot/js/jquery-3.1.0.min.js')?>
<script src="https://code.jquery.com/jquery-migrate-3.1.0.js"></script>
<?$this->template->add_js('application/views/modules/dashboot/js/bootstrap.min.js')?>
    ...
    <div class="col-xs-12 col-sm-6">
      <h4>
        <a href="?book_id=<?=((isset($book) && !empty($book))?$book->book_id:'0')?>&zone=user#tabs-user" class="<?=(('user'==$zone)?'active':'')?>">
          <img class="avatar small" src="<?=confirm_slash($app_root) . 'views/modules/dashboot/images/generic-avatar.png'?>" alt="User avatar" />
          <?=$login->fullname?>
        </a>
<?php if ('user'!=$zone): ?>
        <span class="s">/</span>
...
<?php endif; ?>
    ...
    <nav class="col-xs-12 col-sm-6">
      <h5>
        ...
        <img class="scalar_logo small" src="<?=confirm_slash($app_root) . 'views/modules/dashboot/images/scalar-avatar.png'?>" alt="Small Scalar logo" />
      </h5>
    </nav>
  </div>
</header>

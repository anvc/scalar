...
<?$this->template->add_css('application/views/arbors/admin/jquery-ui.min.css')?>
...
<?$this->template->add_css('application/views/modules/dashboard/tabs.css')?>
<?$this->template->add_js('application/views/arbors/admin/jquery-3.4.1.min.js')?>
<script src="https://code.jquery.com/jquery-migrate-3.1.0.js"></script>
<?$this->template->add_js('application/views/arbors/admin/jquery-ui.min.js')?>
<?$this->template->add_js('application/views/arbors/admin/admin.js')?>
<?$this->template->add_js('application/views/modules/dashboard/tabs.js')?>

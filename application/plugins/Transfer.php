...
<?php
			if ($this->plugin_exists) {
				...
				echo '<div class="alert alert-warning">Please contact a system administrator to install the plugin in a folder named <b>'.strtolower(get_class($this)).'</b> at <b>/application/plugins/</b>.</div>';
			}
?>
				</div>
